...
/**
 * LoroPianaAnthology — Loro Piana Fabric Anthology
...
export default function LoroPianaAnthology() {
  useSEO({
    title: "Loro Piana Fabric Anthology — Luxury Suiting Cloths | Tailors.hk",
    description: "Explore the full Loro Piana fabric anthology — 30 collections of ultra-fine Merino, cashmere and vicuña suiting cloth. Curated by Tailors.hk.",
    canonical: "https://tailors.hk/loro-piana-anthology",
    schema: [
      SCHEMAS.organization(),
      SCHEMAS.breadcrumb([
        { name: 'Home', url: '/' },
        { name: 'Loro Piana Anthology', url: '/loro-piana-anthology' },
      ]),
      {
        "@context": "https://schema.org",
        "@type": "CollectionPage",
        "name": "Loro Piana Fabric Anthology — Luxury Suiting Cloths | Tailors.hk",
        "description": "Explore the full Loro Piana fabric anthology — 30 collections of ultra-fine Merino, cashmere and vicuña suiting cloth. Curated by Tailors.hk.",
        "url": "https://tailors.hk/loro-piana-anthology",
        "about": {
          "@type": "Product",
          "name": "Loro Piana Suiting Fabrics",
          "description": "Loro Piana luxury suiting fabrics — ultra-fine Merino, cashmere and vicuña collections",
